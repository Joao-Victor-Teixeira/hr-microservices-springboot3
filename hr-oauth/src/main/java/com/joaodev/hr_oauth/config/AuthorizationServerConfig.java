...
import com.joaodev.hr_oauth.config.custom.OAuth2ResourceOwnerPasswordAuthenticationConverter;
import com.joaodev.hr_oauth.config.custom.OAuth2ResourceOwnerPasswordAuthenticationProvider;
...
public class AuthorizationServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient registeredClient = RegisteredClient.withId(UUID.randomUUID().toString())
            ...
            .authorizationGrantType(new AuthorizationGrantType("password")) // O nosso tipo customizado
